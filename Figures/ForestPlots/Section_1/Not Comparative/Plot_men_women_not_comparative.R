...
png("../Code/Results/men_women.png", width = 1800, height = 1800, res = 150)
...
## 2) Tidy Both Models
##########################
glm_model_men   <- broom::tidy(model_men_not_relative)
glm_model_women <- broom::tidy(model_women_not_relative)
